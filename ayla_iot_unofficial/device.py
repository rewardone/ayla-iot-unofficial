...
@enum.unique
class VacuumPowerModes(enum.IntEnum):
    """Vacuum power modes"""
    ECO = 1
    NORMAL = 0
    MAX = 2
...
@enum.unique
class VacuumOperatingModes(enum.IntEnum):
...
class Device:
    ...
    def __init__(self, ayla_api: "AylaApi", device_dct: Dict, europe: bool = False):
        ...
        self._device_model_number   = None                      # type: Optional[str]
        self._device_serial_number  = None                      # type: Optional[str]
